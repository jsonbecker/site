...
Local governments can't tax effectively for goods that their constituents don't receive a direct benefit for.
...
- Empirical studies show IGG with much larger impact on provision of goods than income alone.
...
>- Explaining the flypaper effect is important feature of federalism models
  - For now, grants (money in hand) elicits different response than money raised through direction taxation. Game theory models mentioned later help to explain why.
...
>- Maybe there is no problem. Maybe inter-jurisdictional competition results in enhancing efficiency through normal market mechanisms.
...
- How do we understand undesirable restrictions that national governments place on grants?
...
3. Should a subnational government accept the money?
	...
	- Some states received no highway funding because of drinking age restriction.
...
$(q_{S} + q_{N})f_{C,i}d$: credit that voters give government $i$. This is considered to be the total quantity of that good multiplied by the fraction of credit given to government $i$ and the public demand for that policy.
...
Results are hard to read and understand if are not used to reading these papers, but if you use the appendix, it's all simple algebra and a little bit of derivatives to find maximums. Best not to interpret directly and just look for what terms are in the numerator and denominator and the "order" of these terms (what power they're raised to).
